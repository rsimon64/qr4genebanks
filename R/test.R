...
text(x = 5.5, y = 5.5, label = Sys.Date(), family = family)
text(x = 5.5, y = 4.5, label = "Recursos Genéticos", family = family)
text(x = 5.5, y = 3.5, label = "Banco in-vitro", family = family)
text(x = 5.5, y = 2.5, label = "PER1234567890", family = family)
